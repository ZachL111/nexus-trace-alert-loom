...
$repo = "nexus-trace-alert-loom"
$language = "Scala"
$category = "Observability"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/nexus-trace-alert-walkthrough.md")) {
