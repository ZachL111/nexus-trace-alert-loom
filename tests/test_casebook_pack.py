"""Regression checks for the nexus-trace-alert-loom casebook."""
...
from casebook.harness import assert_expected, nexus_trace_alert_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_trace_alert_loom_summary(), assert_expected())
